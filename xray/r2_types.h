...
#define		r2_RT_smap_depth_near		"$user$smap_depth_near"		// ---directional
#define		r2_RT_smap_depth_far		"$user$smap_depth_far"		// ---directional
...
#define		r2_RT_mblur			"$user$mblur"			// rt for motion blur
#define		r2_RT_dof			"$user$dof"				// rt for dof
#define		r2_RT_rain_drops	"$user$rain_drops"		// rt for rain drops
#define		r2_RT_ssao			"$user$ssao"			// rt for ssao
#define		r2_RT_prev_frame0	"$user$prev_frame0"		// rt for prev_frame0
#define		r2_RT_prev_frame1	"$user$prev_frame1"		// rt for prev_frame1
#define		r2_RT_prev_frame2	"$user$prev_frame2"		// rt for prev_frame2
#define		r2_RT_generic0_hd	"$user$generic0_hd"		// ---
#define		r2_RT_generic1_hd	"$user$generic1_hd"		// ---
#define		r2_RT_rmap_depth	"$user$rain_map_depth"	// rt for rain map
#define		r2_RT_rmap_surf		"$user$rain_map_surf"	// rt for rain map
#define		r2_RT_rmap			"$user$rain_map"		// rt for rain map
#define		r2_RT_rmap_temp		"$user$rain_map_temp"	// rt for rain map
// rts for SMAA
#define		r2_RT_smaa_edgetex		"$user$smaa_edgetex"
#define		r2_RT_smaa_blendtex		"$user$smaa_blendtex"		
// rts for fog volumes
#define		r2_RT_FV_faces		"$user$fv_faces"
#define		r2_RT_FV_color		"$user$fv_color"
#define		r2_RT_FV_tc			"$user$fv_tc"
// flares
#define		r2_RT_flares		"$user$flares"
//test for gi
#define		r2_RT_accum_reflected		"$user$accum_reflected"
//blur
#define		r2_RT_blur			"$user$blur"
#define		r2_RT_blur_temp		"$user$blur_temp"
// reflections
#define		r2_RT_reflections	"$user$reflections"
//#define		r2_RT_pre_reflections	"$user$pre_reflections"
#define		r2_RT_rain			"$user$rain"		// ---

#define		r2_RT_smap_copy		"$user$smap_copy"		// ---
...
IC	float	u_diffuse2s	(_vector3<float>& c)				{ return u_diffuse2s(c.x,c.y,c.z);					}
