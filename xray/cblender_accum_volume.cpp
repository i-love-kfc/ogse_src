...
CBlender_accum_volume::CBlender_accum_volume	()	{	description.CLS		= 0;	}
CBlender_accum_volume::~CBlender_accum_volume	()	{	}

void	CBlender_accum_volume::Compile(CBlender_Compile& C)
{
	IBlender::Compile		(C);
