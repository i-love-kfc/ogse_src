...
//	void						copy_shadow_map			();
	...
	// wrappers
	void	__thiscall			w_phase_bloom			();
	void	__thiscall			w_phase_pp				();
	BOOL	__thiscall			w_u_need_PP				();
};
inline void	CRenderTarget::w_phase_bloom			()
{
	__asm
	{
		mov		eax, ecx;
		call	CRenderTarget::phase_bloom;
	};
}
inline void	CRenderTarget::w_phase_pp				()
{
	__asm
	{
		push	ecx;
		call	CRenderTarget::phase_pp;
	};
}
inline BOOL	CRenderTarget::w_u_need_PP				()
{
	__asm
	{
		call	CRenderTarget::u_need_PP;
	};
}