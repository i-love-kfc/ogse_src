...
{
	phase_accumulator				();
//	Msg("frame: %d, actor_torch_enabled, %d, is_torch_processed, %d", Device.dwFrame, (u32)actor_torch_enabled, (u32)is_torch_processed);
...
//	Msg("frame: %d, actor_torch_enabled, %d, is_torch_processed, %d", Device.dwFrame, (u32)actor_torch_enabled, (u32)is_torch_processed);
	...
	Fmatrix			m_Shadow,m_Lmap,m_ViewToLightView;
	{
		...
		CopyMemory(&m_ViewToLightView, &m_Shadow, sizeof(m_ViewToLightView));
	...
	// Draw volume with projective texgen
	{
		...
		RCache.set_c				("lsf_params",		L->lsf_speed, L->lsf_amount, L->lsf_smap_jitter, 0.0);
...
//		Msg("spot light: ptr %d frame %d lsf_params: %f,%f,%f", (u32)L, Device.dwFrame, L->lsf_speed, L->lsf_amount, L->lsf_smap_jitter);
