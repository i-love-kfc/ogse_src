...
#ifdef  _EDITOR
IC void strcpy_s1(char* strDestination,   size_t sizeInBytes,   const char *strSource)
{
...
IC void strcat_s1(char* strDestination,   size_t sizeInBytes,   const char *strSource)
{
	strcat(strDestination, strSource);
}

IC int sprintf_s1(char* dest, size_t sizeOfBuffer, const char* format, ...)
{
	va_list 	mark;
